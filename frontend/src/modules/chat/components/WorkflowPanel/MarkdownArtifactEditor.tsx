...
export function MarkdownArtifactEditor({
  ...
  const { setEditing, registerFlush, registerFooterAction, manualSave, beforeSave, registerSnapshot } = useContext(SlotEditingContext);
  ...
  }, [onSave, readOnly, savePaused, replaceMarkdownSilently, t, beforeSave]);
  ...
  useEffect(() => {
    ...
    if (manualSave || !dirty || readOnly || savePaused || saving || saveError || conflict) return undefined;
  ...
  }, [conflict, dirty, draftMarkdown, readOnly, savePaused, saveError, saving, manualSave]);
