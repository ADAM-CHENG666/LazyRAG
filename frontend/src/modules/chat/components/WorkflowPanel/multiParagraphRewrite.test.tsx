...
beforeEach(async()=>{await i18n.changeLanguage('zh-CN');Range.prototype.getBoundingClientRect=()=>({x:0,y:100,top:100,left:0,right:100,bottom:140,width:100,height:40,toJSON:()=>({})});Range.prototype.getClientRects=()=>[] as unknown as DOMRectList;});
