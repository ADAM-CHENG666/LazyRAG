"""Clustering compute internals.

These functions are driven by ``harness.analysis`` during the standard plan and
are NOT exposed to LLM agents. Agents read the resulting state via the
``get_cluster_summary`` / ``list_cluster_exemplars`` / ``get_step_flow_analysis``
tools in ``evo.tools.cluster``.
"""
...
# ---------------------------------------------------------------------------
# Low-level clustering primitives
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# High-level entry points (called from harness.analysis)
# ---------------------------------------------------------------------------
